...
template = """Công việc của bạn là tạo ra câu hỏi tiếng Việt về thắc mắc của người dùng có thể có về chương trình khuyến mãi sản phẩm.
Câu hỏi được tạo ra cần nêu rõ tên chương trình khuyến mãi sản phẩm. 
Dựa trên thông tin khuyến mãi sản phẩm dưới đây hãy tạo ra 10 câu hỏi của người dùng:
...
4.    Hình thức khuyến mại: Trong thời gian triển khai chương trình, khách hàng sẽ được nhận một trong hai khuyến mại như sau:
...
6. Tổng đài CSKH: 18001091 (nhánh 3).
"""
